        ...
        <section class="py-8 px-6">
          <div class="flex flex-wrap -mx-3 items-center">
            <div class="w-full lg:w-1/2 flex items-center mb-5 lg:mb-0 px-3">
              <span
                class="inline-flex justify-center items-center w-16 h-16 mr-4 bg-green-main rounded-2xl"
              >
                <object
                  class="w-10 h-10"
                  :data="require('../assets/nav/Overview.svg')"
                >
                  Icon for Overview
                </object></span
              >
            ...
            <div class="w-full lg:w-auto ml-auto px-3">
              <a
                class="inline-flex items-center py-2 px-3 mr-3 text-xs font-medium bg-white rounded hover:bg-green-light text-green-main"
                href="#"
              >
                <span class="inline-block mr-1">
                  <object
                    class="w-4 h-4"
                    :data="require('@/assets/general/Settings.svg')"
                  >
                    Icon for Settings
                  </object></span
                >
              ...
              <a
                class="inline-flex items-center py-2 px-3 text-xs text-white font-medium rounded bg-green-main hover:bg-green-highlight"
                href="#"
              >
                <span class="inline-block mr-1">
                  <svg
