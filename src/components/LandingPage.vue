        ...
        <div class="max-w-md mx-auto">
          ...
          <div class="divide-y divide-gray-200">
            <div
              ...
              "
            >
              <h1 class="text-2xl font-bold text-center">Currently Under Construction</h1>
            ...
            <div
              ...
              "
            >
              <Buttons v-show="!showSubscribe" @subscribeToggle="swapComponent" />
              <Subscribe v-show="showSubscribe" @subscribeToggle="swapComponent" />
            </div>
          </div>
        </div>
      </div>
